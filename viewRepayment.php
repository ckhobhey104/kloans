...
<div class="container">
		...
		<div class="input-group-prepend">
			...
			<input class="form-control" type="text" id="search_view_repayment" name="search_view_repayment" placeholder="Search By Name/Serial No.">
		</div>
		<div id="feedback"></div>
		<br/>             
	...
	<!-- <?php include_once("templates/disburseLoan.php");?> -->
	<!-- <?php include_once("templates/edit_disburse_loan.php");?> -->
	 <?php include_once("templates/edit_loan_repayment.php");?> 
	</body>
</html>